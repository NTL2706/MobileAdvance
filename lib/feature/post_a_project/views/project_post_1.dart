...
import 'package:final_project_advanced_mobile/feature/post_a_project/views/project_post_2.dart';
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("This helps your post stand out to the right students. It's the first thing they'll see, so make it Impressive!"),
            SizedBox(
              height: 20,
            ),
            CustomTextField(
