...
class CreateProfilePage extends StatefulWidget {
  CreateProfilePage({super.key, required this.role});
    ...
    await showModalBottomSheet(
      ...
      builder: (ctx) {
        return MultiSelectBottomSheet<String>(
          ...
          onConfirm: (values) {
            final skillSetList =
                context.read<ProfileProvider>().profileRepository.skillSetList;
            setState(() {
              ...
              values.forEach((selectedElement) {
                skillSetList?.forEach((skillSet) {
                  if (skillSet['id'] == int.parse(selectedElement)) {
                    selectedSkillSetList?.add(MultiSelectItem(
                        skillSet['id'].toString(), skillSet['name']));
                  }
                });
              });
            });
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: (selectedTeckStackId != null &&
                              _selectedSkillset.isNotEmpty)
                          ? ElevatedButton(
                              onPressed: () {
